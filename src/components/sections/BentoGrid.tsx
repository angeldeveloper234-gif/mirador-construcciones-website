...
const items = [
    {
        ...
        header: <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-primary/20 to-primary/40 border border-primary/10" />,
    ...
    },
    {
        ...
        description: "Construcciones eficientes con sistemas de ahorro de energía y agua.",
        header: <div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-primary/30 to-zinc-900 border border-primary/10" />,
    ...
    return (
        <section className="py-24 bg-[#0F1115]">
            <div className="container px-4 md:px-6 mx-auto">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-stardom font-bold mb-4 text-white tracking-tight">
